...
/**
 * Get all books based on testament filter
 * @param {string} testament - 'both', 'old', or 'new'
 * @returns {Array} Array of book objects
 */
export function getBooks(testament = 'both') {
  if (testament === 'old') {
 ...
 * Get a random book
 * @param {string} testament - 'both', 'old', or 'new'
 * @returns {Object} Random book object with name and chapters
 */
...
/**
 * Get a random chapter from a specific book or any book
 * @param {string} testament - 'both', 'old', or 'new'
 * @param {Object} book - Optional specific book object
 * @returns {Object} Object with book, chapter number
 */
...
/**
 * Get a random verse from a specific chapter or any chapter
 * @param {string} testament - 'both', 'old', or 'new'
 * @param {Object} book - Optional specific book object
 * @param {number} chapter - Optional specific chapter number
 * @returns {Object} Object with book, chapter, and verse number
 */
export function getRandomVerse(testament = 'both', book = null, chapter = null) {
  const selectedBook = book || getRandomBook(testament);
